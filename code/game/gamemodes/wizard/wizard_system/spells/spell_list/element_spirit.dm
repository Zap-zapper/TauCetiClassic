/obj/effect/proc_holder/magic/spirits
...
/obj/effect/proc_holder/magic/spirits/check_turf_cast(turf/target)
	if(is_blocked_turf(target))
		to_chat(owner.current, "<span class='wizard'>This place is occupied! I can't summon a magical spirit here!</span>")
		return
	return TRUE


/obj/effect/proc_holder/magic/spirits/cast_on_turf(turf/target)
