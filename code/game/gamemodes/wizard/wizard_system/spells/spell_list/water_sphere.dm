...
/obj/effect/proc_holder/magic/shoot/water_sphere
	name = "Water sphere"
	desc = ""
	mana_cost = 0
...
/obj/effect/proc_holder/magic/shoot/water_sphere/process()
	switch(owner.current.a_intent)
		if("help")
			name = "Stone arrow"
			projectile = /obj/item/projectile/bullet/stone_arrow
			shootsound = 'sound/weapons/guns/gunshot_silencer.ogg'			//Change sound effect
		if("disarm")
			name = "Water sphere"
			projectile = /obj/item/projectile/magic/water_sphere
			shootsound = 'sound/magic/water.ogg'
