/obj/effect/proc_holder/magic/creation
...
/obj/effect/proc_holder/magic/creation/check_turf_cast(turf/target)
...
/obj/effect/proc_holder/magic/creation/cast_on_turf(turf/target)
