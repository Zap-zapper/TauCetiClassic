/obj/effect/proc_holder/magic/dragon_call
	name = "Dragon's call"
	desc = ""
	mana_cost = 0
	ultimate = TRUE
...
/obj/effect/proc_holder/magic/dragon_call/check_turf_cast(turf/target)
...
/obj/effect/proc_holder/magic/dragon_call/cast_on_turf(turf/target)
...
/mob/living/simple_animal/hostile/dragon
	name = "red dragon"
	desc = "Came to kidnap princesses and devour knights. Watch out for fiery breath!"
	health = 2500
	maxHealth = 2500
	attacktext = "chomps"
