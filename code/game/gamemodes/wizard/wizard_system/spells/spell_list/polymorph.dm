/obj/effect/proc_holder/magic/polymorph
	name = "Polymorph"
	desc = ""
	mana_cost = 0
	cooldown = 60
...
//Forbid using on shadow twin

/obj/effect/proc_holder/magic/polymorph/check_mob_cast(mob/living/target)
	if(!ishuman(target))
...
/obj/effect/proc_holder/magic/polymorph/cast_on_mob(mob/living/carbon/human/target)
